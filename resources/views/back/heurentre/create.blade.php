...
<div class="col-lg-12">
          <div class="card ">
            <div class="card-header bg-blue">
              <h5 class="text-white m-b-0">FORMULAIRE D'ENREGISTREMENT DE heurentre</h5>
              <button type="submit"  > <a href="{{route('heurentre.index')}}"class="btn btn-primary">Lister </a> </button>
            </div>
            <div class="card-body">
             ...
             <form action="{{route('heurentre.store')}}" method="post" enctype="multipart/form-data">
                                        @csrf
              <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                  <div class="form-group has-feedback">
                    <label class="control-label">Heur de entre</label>
                    <input class="form-control" placeholder="" type="text" name="heurentre">
