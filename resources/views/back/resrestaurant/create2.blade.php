...
<div class="col-lg-12">
          <div class="card ">
            ...
            <div class="card-body">
             ...
             <form action="{{route('resrestaurant.store')}}" method="post" enctype="multipart/form-data">
                 @csrf
                 @method('POST')
              <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group has-feedback">
                      <label class="control-label">Table à réserver</label>
                      <select class="custom-select form-control" name="numerotable">
                          @foreach($tables as $table)
                              <option value="{{$table->numerotable}}">{{$table->numerotable}}</option>
                          @endforeach
                      </select>
                  </div>
                <div class="col-md-12">
