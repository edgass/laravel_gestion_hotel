            ...
            <div class="card-body">
                  @if(session()->has('message'))
                                    <div class="alert alert-icon alert-success">
                                        ...
                                        @endforeach
                                        @endif
             <form action="{{route('reschambre.store2',$id)}}" method="post" enctype="multipart/form-data">
                 @csrf
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group has-feedback">
                    <label class="control-label">NumPieceID</label>
                    <input class="form-control" type="text" name="numPieceID" value="{{$id}}" disabled="disabled">
